...
import { ProgramManagementSecondDetailsComponent } from './program-management-details/program-management-details.component';
...
export class ProgramManagementSecondComponent implements OnInit {
  public programManagementForm!: FormGroup;

  @ViewChild('programDetails')
  programDetails!: ProgramManagementSecondDetailsComponent;
